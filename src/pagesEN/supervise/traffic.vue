  ...
  <div class="views-container">
    <div class="echarts-div">
      <div class="echarts-left">
        <h3>Parking space dynamic monitoring</h3>
      ...
      <div class="echarts-right">
        <div class="weather-title">
          <h3>Park Road Traffic Monitoring</h3>
          <el-select placeholder="Please select" value='By hour' style="width:120px" size="small">
    ...
    <div class="table-div mt20">
      <div class="tableList">
        <h3>Statistics of parking spaces today</h3>
        <ul>
      ...
      <div class="weather-qa">
        <div class="weather-title">
          <h3>Real time admission vehicle detection</h3>
        </div>
...
export default {
  ...
  data: () => ({
    ...
    statisticsData: [{
      ...
      title: 'Gross income today',
      count: 24995
    }, {
      bgcolor: 'bg_orange',
      title: 'Parking turnover rate',
      count: 1.26
    }],
    flowData: [{
      road: 'Jiabin Road',
      statusText: 'Mild congestion'
    }, {
      road: 'Renmin Road',
      statusText: 'Open'
    }, {
