        ...
        <div class="c-list-div">
            <ul>
                <li>
                    <dl>
                        <dt class="clearfix">
                                <div class="title-name">Visitor Statistics</div>
                                <div class="floatL">
                                    <span>Date range：</span>
                                    <el-date-picker class="el-date-h"  size="small" v-model="value4" type="datetimerange" align="right" start-placeholder="Start date"  end-placeholder="End date"  :picker-options="pickerOptions2"></el-date-picker>
        ...
        <div class="c-list-div">
            <ul>
                <li>
                    <dl>
                        <dt class="clearfix">
                                <div class="title-name">Visitor Traffic Trend</div> 
                            </dt>
                    </dl>
                </li>
            </ul>
