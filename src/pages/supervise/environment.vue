			...
			<div class="echarts-div">
				...
				<div class="echarts-right" >
					<div class="weather-title">
						<h3>天气环境</h3>
						<el-select placeholder="请选择" value='按照小时统计' size="small">
		                    <el-option value='按照小时统计'></el-option>
		                </el-select>
					</div>
			...
			<div class="table-div mt20">
				<div class="tableList">
					<el-table ref="multipleTable" :data="tableData" stripe tooltip-effect="dark" >
		                <el-table-column prop="order" label="主要污染物" align="center"></el-table-column>
				...
				<div class="weather-qa">
					<el-table class="table-qa" ref="multipleTable" :data="tableData2" stripe tooltip-effect="dark">
		                <el-table-column prop="order" label="区域" align="center"></el-table-column>
		                <el-table-column prop="order" label="AQI" align="center"></el-table-column>
		                <el-table-column prop="contractNum" label="空气质量" align="center"></el-table-column>
		            </el-table>
				</div>
			</div>
		</div>
                ...
                success: function(data) {
                    $.each(data, function(i, v) {
                        if (i == 'success') {
                        	...
                        	that.weather_curr = v.weather_curr;
                        	that.wind = v.wind;
                        	that.winp = v.winp;
