    ...
    <div class="charts">
      <div class="chartbox line_blue">
        <div class="charttitle bg_blue">
          <span class="c_darkgray">建筑用电 </span>
        </div>
        <div class="chartdetail">
          <span class="c_gray">年建造总用电量 </span><span class="ml10 c_blue">3663.6 千瓦时 </span>
          <br/>
          <span class="c_gray">年建造节约电量 </span><span class="ml10 c_blue">568.2 千瓦时</span>
        </div>
      ...
      <div class="chartbox line_purple">
        <div class="charttitle bg_purple">
          <span class="c_darkgray">用电耗费</span>
        </div>
        <div class="chartdetail">
          <span class="c_gray">年建筑总用电费 </span><span class="ml10 c_blue">3623.30 元 </span>
          <br/>
          <span class="c_gray">年建造节约电费 </span><span class="ml10 c_blue">561.95 元 </span>
        </div>
        <div class="chart">
      ...
      <div class="chartbox line_green">
        <div class="charttitle bg_green">
          <span class="c_darkgray">建筑节能</span>
        </div>
        <div class="chartdetail">
          <span class="c_gray">运行节能率 </span><span class="ml10 c_blue">13.32%</span>
          <br/>
          <span class="c_gray">设计节能率 </span><span class="ml10 c_blue">20%</span>
        </div>
        <div class="chart">
