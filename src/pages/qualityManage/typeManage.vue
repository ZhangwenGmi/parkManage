  ...
  <div id="container">
      ...
      <div class="container-right">
        ...
        <el-table class="mt20" ref="multipleTable" :data="tableData3" stripe tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column prop="code" label="类型名称" align="center"></el-table-column>
          <el-table-column prop="name" label="权重" align="center"></el-table-column>
        </el-table>
        <div style="margin-top: 20px">
          <el-button type="primary" icon="plus" size="small">添加</el-button>
          <el-button type="primary" icon="edit" size="small" class="el-button--edit">编辑</el-button>
