...
export default {
    data() {
        ...
        methods: {
            getData() {
               	const mockData = location.protocol + '//' + location.host + '/static/mock/superviseMenu.js';
                //const mockData = location.protocol + '//' + location.host + '/dist/static/mock/superviseMenu.js';
